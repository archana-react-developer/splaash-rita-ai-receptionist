		...
		*/
		...
		this.handleDataError = (event) => {
			...
			if (event instanceof ErrorEvent && event.error) {
				...
				this.log.error("DataChannel error on ".concat(channelKind, ": ").concat(event.message), { error });
...
//#endregion
//#region node_modules/retell-client-js-sdk/dist/index.m.js
function r(t, e) {
	return r = Object.setPrototypeOf ? Object.setPrototypeOf.bind() : function(t, e) {
		return t.__proto__ = e, t;
	}, r(t, e);
}
var c = new TextDecoder(), s = /* @__PURE__ */ function(t) {
	var s, l;
	function u() {
		var e;
		return (e = t.call(this) || this).room = void 0, e.connected = !1, e.isAgentTalking = !1, e.analyzerComponent = void 0, e.captureAudioFrame = void 0, e;
	}
	l = t, (s = u).prototype = Object.create(l.prototype), s.prototype.constructor = s, r(s, l);
	var d = u.prototype;
	return d.startCall = function(t) {
		try {
			var n = this, o = function(o, i) {
				try {
					var a = (n.room = new Room({
						audioCaptureDefaults: {
							autoGainControl: !0,
							echoCancellation: !0,
							noiseSuppression: !0,
							channelCount: 1,
							deviceId: t.captureDeviceId,
							sampleRate: t.sampleRate
						},
						audioOutput: { deviceId: t.playbackDeviceId }
					}), n.handleRoomEvents(), n.handleAudioEvents(t), n.handleDataEvents(), Promise.resolve(n.room.connect("wss://retell-ai-4ihahnq7.livekit.cloud", t.accessToken)).then(function() {
						console.log("connected to room", n.room.name), n.room.localParticipant.setMicrophoneEnabled(!0), n.connected = !0, n.emit("call_started");
					}));
				} catch (t) {
					return i(t);
				}
				...
				n.emit("error", "Error starting call"), console.error("Error starting call", t), n.stopCall();
			});
		...
		var t;
		this.connected && (this.connected = !1, this.emit("call_ended"), null == (t = this.room) || t.disconnect(), this.isAgentTalking = !1, delete this.room, this.analyzerComponent && (this.analyzerComponent.cleanup(), delete this.analyzerComponent), this.captureAudioFrame && (window.cancelAnimationFrame(this.captureAudioFrame), delete this.captureAudioFrame));
	}, d.mute = function() {
	...
	}, d.handleAudioEvents = function(t) {
		var e = this;
		this.room.on(RoomEvent.TrackSubscribed, function(n, r, c) {
			n.kind === Track.Kind.Audio && n instanceof RemoteAudioTrack && ("agent_audio" === r.trackName && (e.emit("call_ready"), t.emitRawAudioSamples && (e.analyzerComponent = createAudioAnalyser(n), e.captureAudioFrame = window.requestAnimationFrame(function() {
		...
		this.room.on(RoomEvent.DataReceived, function(e, n, o, i) {
			try {
				...
				var a = c.decode(e), r = JSON.parse(a);
				"update" === r.event_type ? t.emit("update", r) : "metadata" === r.event_type ? t.emit("metadata", r) : "agent_start_talking" === r.event_type ? (t.isAgentTalking = !0, t.emit("agent_start_talking")) : "agent_stop_talking" === r.event_type ? (t.isAgentTalking = !1, t.emit("agent_stop_talking")) : "node_transition" === r.event_type && t.emit("node_transition", r);
			} catch (t) {
				console.error("Error decoding data received", t);
			}
		});
	}, u;
